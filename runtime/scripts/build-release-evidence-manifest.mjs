...
if (smoke.transportDrillOk !== true || smoke.pilotUiOk !== true || smoke.productionUiOk !== true || smoke.assistUiOk !== true || smoke.reliabilityUiOk !== true) throw new Error('Smoke transport, Pilot UI, Production UI, or Assist or Reliability UI evidence is incomplete');
