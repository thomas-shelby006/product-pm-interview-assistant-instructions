...
test('release surfaces identify PMIA runtime 0.10.4', async () => {
  ...
  assert.match(rootReadme, /0\.10\.4/);
  assert.match(extensionReadme, /Runtime 0\.10\.4/);
  ...
  assert.match(deploymentGuide, /0\.10\.4/);
});
