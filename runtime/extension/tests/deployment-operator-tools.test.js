...
test('readiness report verifies both packages and emits stable remediation codes', async () => {
  ...
  assert.match(source, /pmia-deployment-readiness\/v1/);
});
...
test('inventory is derived from readiness, manifests, evidence, Git and retained layout', async () => {
