...
const TRANSIENT_STATUS = /^(?:transcrib(?:e|ed|ing)(?: audio| speech)?|translat(?:e|ed|ing)(?: audio| speech)?|listening|processing(?: audio| speech)?|connecting|starting voice(?: mode)?|voice mode(?: active)?|speak now|start speaking|tap to interrupt|release to send|recording)(?:[\s.?!?]*)$/i;
