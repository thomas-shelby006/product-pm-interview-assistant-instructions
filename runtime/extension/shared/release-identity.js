...
export function buildReleaseIdentity({ name = 'PMIA', version = '0.8.0', commit = '', manifestHash = '', evidenceHash = '', builtAt = 0 } = {}) {
...
export function validateReleaseIdentity(value = {}) {
  ...
  return { ok: missing.length === 0 && /^0\.8\./.test(String(value.version || '')), missing, version: String(value.version || ''), commit: String(value.commit || '') };
}
