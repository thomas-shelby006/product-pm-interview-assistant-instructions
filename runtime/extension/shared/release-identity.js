...
export function buildReleaseIdentity({ name = 'PMIA', version = '0.9.0', commit = '', manifestHash = '', evidenceHash = '', builtAt = 0 } = {}) {
...
export function validateReleaseIdentity(value = {}) {
  ...
  return { ok: missing.length === 0 && /^0\.9\./.test(String(value.version || '')), missing, version: String(value.version || ''), commit: String(value.commit || '') };
}
