...
const LABELS = Object.freeze({
  pause_toggle: 'Pause or resume forwarding', resume_catch_up: 'Resume and catch up', check_live: 'Check live health', repair_runtime: 'Repair runtime',
  ...
  open_command_palette: 'Open command palette', open_shortcut_help: 'Open shortcut help'
});
const GROUPS = Object.freeze({
  pause_toggle: 'Delivery', resume_catch_up: 'Delivery', submit_now: 'Delivery', interrupt_latest: 'Delivery',
  ...
  open_command_palette: 'Navigate', open_shortcut_help: 'Navigate'
});
