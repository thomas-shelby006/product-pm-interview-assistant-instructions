// ==UserScript==
// @name         ChatGPT Virtual Scroll (Optimized for PWA )
// @namespace    https://github.com/9ghtX/ChatGPT-Virtual-Scroll
// @version      2.7.1
// @description  Optimizes long ChatGPT threads. Fixed Lazy Janitor backlog and Syntax Highlighting CPU spike.
// @author       9ghtX + True Fix
// @match        https://chatgpt.com/*
// @match        https://chat.openai.com/*
// @updateURL    http://127.0.0.1:8123/virtual-scroll.user.js
// @downloadURL  http://127.0.0.1:8123/virtual-scroll.user.js
// @grant        none
// @license      MIT
// ==/UserScript==
...
(function () {
  ...
  function getAnchorTurn() {
    ...
    for (const t of turns) {
      if (t.getBoundingClientRect().bottom > scrollerTop + 1) return t;
    }
  ...
  function captureAnchor() {
    const anchor = getAnchorTurn();
    if (!anchor) return null;
    return { el: anchor, top: anchor.getBoundingClientRect().top };
  }
